...
import com.finwin.travancore.traviz.home.reacharge.pojo.get_circle_response.CircleData;
import com.finwin.travancore.traviz.home.reacharge.pojo.get_operator_response.OperatorData;
    ...
    public void clickProceed(View view) {
        if ((amount.get().equals("")) || (mobileOrId.get().equals("")) || (circle.get().equals("-1")) || (operator.get().equals("-1"))) {
            if (operator.get().equals("-1")) {
                Snackbar.make(view, "Please select an Operator", Snackbar.LENGTH_SHORT).show();
            } else if (circle.get().equals("-1")) {
                Snackbar.make(view, "Please select a Circle", Snackbar.LENGTH_SHORT).show();
            } else if (mobileOrId.get().equals("")) {
                Snackbar.make(view, "Mobile number or Id cannot be empty!", Snackbar.LENGTH_SHORT).show();
            } else if (amount.get().equals("")) {
                Snackbar.make(view, "Amount cannot be empty!", Snackbar.LENGTH_SHORT).show();
            }
        }else
        {
