...
import com.finwin.travancore.traviz.home.transfer.fund_transfer_account.pojo.genarate_otp.GenarateOtpResponse;
                        ...
                        try {
                            ...
                            if (validateMpinResponse.getValue() != null) {
                               ...
                               // String error=validateMpinResponse.getError();
                                mAction.setValue(new NeftAction(NeftAction.API_ERROR, "invalid mpin"));
                            }
